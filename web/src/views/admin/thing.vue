      ...
      >
        <div>
          <a-form ref="myform" :label-col="{ style: { width: '80px' } }" :model="modal.form" :rules="modal.rules">
            <a-row :gutter="24">
              <a-col span="24">
                <a-form-item label="医生姓名" name="title">
                  <a-input placeholder="请输入" v-model:value="modal.form.title" />
                </a-form-item>
              </a-col>
              <a-col span="24">
                <a-form-item label="科室分类" name="classificationId">
                  <a-select
                    placeholder="请选择"
                    allowClear
                    :options="modal.cData"
              ...
              <a-col span="12">
                <a-form-item label="挂号费" name="price">
              ...
              <a-col span="12">
                <a-form-item label="职称" name="zhicheng">
                  <a-select placeholder="请选择" allowClear v-model:value="modal.form.zhicheng">
              ...
              <a-col span="12">
                <a-form-item label="是否专家">
                  <a-select placeholder="请选择" allowClear v-model:value="modal.form.expert">
              ...
              <a-col span="12">
                <a-form-item label="在诊时间">
                  <a-select mode="multiple" placeholder="请选择" allowClear v-model:value="modal.form.zzsj">
                    <a-select-option key="周一" value="周一">周一</a-select-option>
                    <a-select-option key="周二" value="周二">周二</a-select-option>
                    <a-select-option key="周三" value="周三">周三</a-select-option>
                    <a-select-option key="周四" value="周四">周四</a-select-option>
                    <a-select-option key="周五" value="周五">周五</a-select-option>
                    <a-select-option key="周六" value="周六">周六</a-select-option>
                    <a-select-option key="周日" value="周日">周日</a-select-option>
                  </a-select>
                </a-form-item>
              </a-col>
              <a-col span="12">
...
<script setup>
  ...
  const columns = reactive([
    ...
    },
    {
      ...
      dataIndex: 'status',
      key: 'status',
      customRender: ({ text, record, index, column }) => (text === '0' ? '在岗' : '休息'),
    },
    {
      title: '操作',
      dataIndex: 'action',
  ...
  const modal = reactive({
    ...
    rules: {
      ...
      zhicheng: [{ required: true, message: '请输入', trigger: 'change' }],
  ...
  const handleEdit = (record) => {
    ...
    // 在诊日期
    if (modal.form.zzsj) {
      modal.form.zzsj = modal.form.zzsj.split(',');
    }
  };
  ...
  const handleOk = () => {
    myform.value
      ...
      .then(() => {
        ...
        if (modal.form.zhicheng) {
          formData.append('zhicheng', modal.form.zhicheng);
        }
        if (modal.form.expert) {
          formData.append('expert', modal.form.expert);
        }
        if (modal.form.zzsj) {
          formData.append('zzsj', modal.form.zzsj);
        }
